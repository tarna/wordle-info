...
# Reporting a Bug
When reporting a issue to our [Issue Tracker](https://github.com/tarna/wordle-info/issues) make sure to be as clear and concise as possible.
...
# Fixing a Bug
When fixing a bug and there isn't already an issue open on our [Issue Tracker](https://github.com/tarna/wordle-info/issues) make sure to open one and link your Pull Request to it so we know exactly why you're making the changes you are.
